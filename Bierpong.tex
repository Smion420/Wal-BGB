...
Für jeden getroffenen Standardwurf und jeden getroffenen Trickshot bekommt ein Spieler einen OnFire-Stack(Beim \textit{ Eye to Eye} treffen bringt keinen OnFire-Stack). Trifft er einen Wurf in der regulären Wurfphase oder in der OnFirephase nicht, werden seine OnFire-Stacks wieder auf 0 gesetzt.
\section{Behinderung}\label{Behinderung}
Es ist verboten, den Gegner physisch beim Wurf zu behindern. 
\section{Ball bleibt auf Bechern liefen}\label{liegenbleiben}
